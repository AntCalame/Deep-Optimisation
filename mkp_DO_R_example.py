...
problem = MKP("COProblems\\mkp\\problems30d.txt", "COProblems\\mkp\\fitnesses30d.txt", 1, device)
...
while True:
    ...
    handler.learn_from_population(population, optimizer, l1_coef=l1_coef, batch_size=pop_size, p=param)
