...
data = torch.load("data/exp_tuning_all_n1-n2.pt")
SSS=r""
...
class Analysis:
    ...
    def analysis(self):
        ...
        plt.grid()
        plt.title("Comparison of Fitness Ratio (All)")
        ...
        plt.xticks(torch.arange(1,21))
        plt.grid()
        plt.title("Comparison of Success Rate (All)")
        ...
        plt.ylabel("Fitness Ratio")
        plt.grid()
        plt.title("Comparison of Fitness Ratio (All) (zoomed in)")
        plt.tight_layout()
        ...
        plt.ylabel("Success Rate")
        plt.grid()
        plt.title("Comparison of Success Rate (All) (zoomed in)")
        ...
        plt.suptitle("Analysis of Layer 1 Distances for several Fisher Multiplier (All)", fontsize=32)
