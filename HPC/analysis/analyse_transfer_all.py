...
train = torch.load("data/exp_tuning_all_n1-n2.pt")
test = torch.load("data/exp_tuning_all_n1-n2_test.pt")
...
class Analysis:
    ...
    def analysis(self):
        ...
        plt.legend()
        plt.savefig(SSS+'\\ae-oc.pdf', format='pdf', bbox_inches='tight')
        plt.show()
        ...
        plt.xlabel("Transition")
        plt.legend()
        plt.savefig(SSS+'\\ae-ss.pdf', format='pdf', bbox_inches='tight')
        plt.show()
        ...
        plt.legend()
        plt.savefig(SSS+'\\ae-ms.pdf', format='pdf', bbox_inches='tight')
        plt.show()
