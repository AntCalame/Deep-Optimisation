...
train = torch.load("data/exp4.pt")
test = torch.load("data/exp4_test.pt")
...
class Analysis:
    ...
    def analysis(self):
        ...
        plt.legend()
        plt.savefig(SSS+'\\oc-b-'+size+'.pdf', format='pdf', bbox_inches='tight')
        plt.show()
        ...
        plt.xlabel("Transition")
        plt.legend()
        plt.savefig(SSS+'\\ss-b-'+size+'.pdf', format='pdf', bbox_inches='tight')
        plt.show()
        ...
        plt.legend()
        plt.savefig(SSS+'\\ms-b-'+size+'.pdf', format='pdf', bbox_inches='tight')
        plt.show()
