    ...
    for i in range(nb_total):
        ...
        for j in range(4):
            ...
            for ss,d in data.items():
                ...
                Data["fitness"][idx_dim][idx_tight][idx_prb][idx_ite][int(ss)]=d["fit"]
                Data["time"][idx_dim][idx_tight][idx_prb][idx_ite][int(ss)]=d["time"]
                Data["evaluation"][idx_dim][idx_tight][idx_prb][idx_ite][int(ss)]=d["eval"]
